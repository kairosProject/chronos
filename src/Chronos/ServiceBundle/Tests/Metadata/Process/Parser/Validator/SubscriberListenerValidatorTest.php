...
/**
 * Subscriber listener validator test
 *
 * This class is used to validate the SubscriberListenerValidator class
 *
 * @category Test
 * @package  Chronos
 * @author   matthieu vallance <matthieu.vallance@cscfa.fr>
 ...
 * @link     http://cscfa.fr
 */
class SubscriberListenerValidatorTest extends AbstractTestClass
{
    /**
     * Test isValid
     *
     * Validate the Chronos\ServiceBundle\Metadata\Process\Parser\Validator\SubscriberListenerValidator::isValid
     * method
     *
     * @return void
     */
    public function testIsValid()
    {
        ...
        $this->assertFalse($instance->isValid([EventSubscriber::class, 12]));
        $this->assertTrue($instance->isValid([EventSubscriber::class]));
        ...
        $this->assertFalse($instance->isValid(['array_map']));
    ...
    {
        return SubscriberListenerValidator::class;
    }
}
